  ...
  return (
    ...
    >
      <svg
        ...
        aria-hidden
      >
        <path d="M0 40 L100 20 L180 60 L260 30 L400 50" stroke="white" strokeWidth="2" fill="none" />
        <path d="M0 120 L120 140 L220 100 L320 150 L400 120" stroke="white" strokeWidth="2" fill="none" />
        <path d="M40 0 L60 200" stroke="white" strokeWidth="2" fill="none" />
        <path d="M300 0 L280 200" stroke="white" strokeWidth="2" fill="none" />
      </svg>
      <div className="relative flex flex-col items-center gap-2 text-center text-cream">
        <svg viewBox="0 0 24 32" className="h-10 w-10 text-green" fill="currentColor" aria-hidden>
